---
type: NamingProposal
title: Naming and the new core - synthesis proposal, revision 3
description: "A candidate successor naming compact: one canonical semantic name per entity within an authority, a declared family of reference registers, federated native planes, self-proposed and accepted actor identity, earned naming, bounded certainty, and a deliberately deferred tooling seam."
resource: /constitution/naming/exploration/proposal3.sol56x.md
tags: [naming, identity, references, agents, anchors, namespace, beads, okf, synthesis, rekon-core]
status: draft
generated: { by: "model:openai/gpt-5.6-sol#max", at: 2026-09-03T14:47:02-04:00 }
stale_after: 2026-12-03T00:00:00-05:00
extensions:
  local_knowledge_id: naming-proposal3
  qualified_knowledge_id: rekon-constitution-naming-proposal3
  revision_of: /constitution/naming/exploration/proposal2.glm53m.md
  ticket: rekon-con-naming
  wave: naming exploration proposal revision 3 synthesis
  actor: rekon-naming-concordance
  actor_status: self-proposed
  independence: No sibling proposal3 artifact was consulted.
  succession_candidate_for:
    - /constitution/naming/exploration/proposal2.glm53m.md
    - /constitution/README.md#doc-constitution-references
    - /constitution/README.md#doc-constitution-namespace
sources:
  - id: proposal0-glm53m
  ...
  - id: draft0-gpt56lx
    ...
    author: model:openai/gpt-5.6-luna#xhigh
  - id: draft0-sol56x
...
<a id="naming-reference-registers"></a>
...
<a id="naming-derived-vs-declared"></a>
...
<a id="naming-proposal3-constellation"></a>
...
flowchart TD
    ...
    naming-one-name-locality -->|governs| naming-reference-registers
    naming-reference-registers -->|includes| naming-citation-token
    naming-contextual-elision -->|supplies forms to| naming-reference-registers
    naming-derived-vs-declared -->|reconciled by| naming-slug-at-mint
    naming-slug-at-mint -->|supplies anchors to| naming-reference-registers
    naming-location-separation -->|requires| naming-identity-change
    naming-coordinate-context -->|makes meaningful| naming-resolution-promise
    naming-reference-registers -->|resolved by| naming-resolution-promise
    naming-native-authority -->|decentralizes| naming-semantic-fabric
    naming-federated-authority -->|scopes| naming-semantic-fabric
    naming-plane-federation -->|constitutes| naming-semantic-fabric
    naming-work-knowledge-seam -->|protects| naming-plane-federation
    naming-reference-pressure -->|admits entities to| naming-semantic-fabric
    naming-ceremony-budget -->|limits| naming-reference-pressure
    naming-actor-handshake -->|tests| naming-one-name-locality
    naming-actor-braid -->|supports| naming-actor-continuity
    naming-role-is-relation -->|protects| naming-actor-handshake
    naming-human-presence -->|specializes| naming-actor-handshake
    naming-human-trust-boundary -->|constrains| naming-human-presence
    naming-certainty-bundle -->|supports| naming-observer-relative-certainty
    naming-attestation-boundary -->|limits| naming-certainty-bundle
    naming-tooling-seam -->|sustains| naming-semantic-fabric
    naming-semantic-fabric -->|offered as| naming-superseding-home
```
...
<a id="naming-proposal3-cross-references"></a>
...
<a id="naming-proposal3-identifier-ledger"></a>
...
<a id="naming-proposal3-source-comparison"></a>
