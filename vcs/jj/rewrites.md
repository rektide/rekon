...
description: Verified jj 0.40.0 behavior for duplicate/split/rebase on author and committer timestamps, the plain-vs-A/B/o split forms, bookmark forwarding and divergence, and pinning dates via the git-colocation escape hatch.
resource: /vcs/jj/rewrites.md
tags: [vcs, jj, git, rewrites, timestamps, split, bookmarks, divergence]
status: stable
generated: { by: model:zai-coding-plan/glm-5.3-max, at: 2026-09-03 }
verified: { by: inherited from experiments0 (paste-tested in scratch repos + the live watchwoman repo, jj 0.40.0, 2026-09-03); duplicate/split timestamps, change-id assignment, bookmark forwarding, headless split failure, and --allow-backwards refusal re-spot-checked in a scratch repo at promotion, at: 2026-09-03 }
