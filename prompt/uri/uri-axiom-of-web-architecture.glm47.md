...
[Up to Design Issues](Overview.html)
...
- [Universal Resource Identifiers](#uri)
  ...
  - [Sameness](#same)
  - [Identity](#identity)
  - [Canonicalization - when is a URI the saem URI?](#canonicalization)
  - [Identity abuse](#abuse)
  - [Not a unique space, just universal](#nonunique)
- [Identity, State and GET](#state)
  - [Opacity](#opaque)
  - [Query strings](#Query)
- [Relative URIs](#relative)
  - [Matrix spaces](#matrix)
- [The properties of different URI schemes](Axioms.html#Properties)
...
#### [Axiom 2b: identity](Axioms.html#Universality)
...
(I had an idea to make special form of relative URIs for these. See [Matrix URIs](MatrixURIs.html) for the idea, not a feature of the web as of 2001.)

## The properties of different URI schemes

As noted above, the concept of a URI itself does not define the particular identity properties which exist between a URI and the resource associated with it. The [axiom above](Axioms.html#Universality) leaves the owner of the URI to define it. However, different URI schemes are defined and implemented in different ways, and this itself can impose restrictions on the mapping.
...
The Web way is to have a reference to one URI. If in the same document you want to incldue information such as other in some ways equivalent identifiers, then you embed that in your document as [metadata](Metadata.html), to be discussed later.
...
- [Cool URIs don't change](/Provider/Style/URI.html) - persistence in the HTTP space
- [Hall of Flame](AxiomsHAF) -- how not to do it

---

$Id: Axioms.html,v 1.36 2009/03/17 17:25:35 timbl Exp $

[Next: Fragmement Identifiers](Fragment.html)
